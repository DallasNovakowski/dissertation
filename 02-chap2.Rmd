...
As a manipulation check (and in addition to the envy items in Study 1), participants were asked to report whether they believed the incomes were disbursed fairly, before making their consumption decision. Likewise, participants used seven-point likert scales (1 Strongly agree - 7 Strongly disagree) to report on their desire to keep their money. It could be the case that participants in the inequality condition exhibit some advantageous inequity aversion. This guilt could lead them to spend more (reducing their overall income) or less (making it easier to be stolen from) on the security product. Thus, rather than assuming that participants are responding in accordance with a motivation to improve their payoffs, we elected to measure it and add it as a covariate in the analyses. In addition, participants reported as whether they believed that their partners thought the incomes were fair:
