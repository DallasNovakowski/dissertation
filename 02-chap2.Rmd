...
Inequality is a reasonable starting point to describe whether valued resources are being distributed fairly. If only some people receive desired goods, with others receiving little, it quickly prompts questions as to why some individuals are being left worse-off. For instance, among Norwegian youths making decisions whether to share a resource, @almås2010 found that their younger participants were strict egalitarians (averse to any inequality). However, adolescent participants increasingly accepted inequality when the disparities came from differences in productivity. This is only one example of a broad literature suggesting that concerns over equity, deservingness, and fairness are critical in understanding how people respond to inequality. The following chapter will examine whether distributional fairness impacts distrust and security consumption within individuals.
...
Important to this project's theory of envy anticipation, some authors suggest that people are not actually inequality-averse, but instead inequity-averse, predicting that people can actually be very tolerant of an unequal, but fair outcome. In fact, the idea of inequity aversion has been specifically formulated in response to explain the proposer/responder patterns in the Ultimatum and Dictator games [@fehr1999].

SUPPORTING EVIDENCE HERE. THEN IMPLICATIONS FOR RISKY/FRUSTRATED BEHAVIOUR

In fact, models in behavioural economics regarding social preferences have been specifically designed to explain the proposer/responder patterns in the Ultimatum games.

<!--# Individuals are argued to demonstrate both disadvantageous inequity aversion (receiving less than a partner) as well as a weaker aversion to advantageous inequity [receiving more; @fehr1999; @loewenstein1989]. this is in chapter 1 -->

The argument for fairness considerations in inequality aligns well with some theories of envy, namely those positing a "benign" as well as a "malicious" envy. Benign envy is argued occur when the person believes that the envied person's advantage is deserved, and to be associated with a motivation to improve oneself. By contrast, malicious envy is characterized by a desire to harm the comparison target, and is elicited when the individual believes that their environment is unfair [@vandeven2012].

(e.g., "the social disappointment hypothesis---according to which food refusals express chimpanzees' disappointment in the human experimenter for not rewarding them as well as they could have" [@engelmann2017]

@dawes2007 and @wobker2015 found that individuals are willing to spend their own money to reduce the payoffs of better-off partners

<!--# theoretical development in behavioural economics has tended to downplay the role of strict  -->
...
Behavioural economists have found that participants who earned an advantaged position (versus random assignment) are less generous towards their fellow participants (Hoffman, McCabe, Shachat, & Smith, 1994). Similarly, van de Ven et al. (2010) found that under conditions of inequality, those who are better off are more likely to engage in helping behaviours when they believe that their disadvantaged partner is frustrated by the disparity and harboring antagonistic motivations (i.e., "malicious envy" Crusius & Lange, 2014). By contrast, "winners" are actually less likely to help if they believe that the observed disparity has motivated their partner to improve themselves (i.e., the partner experiences "benign envy").
...
> Responders reject offers of 20% about half the time, and rejection is associated with emotional activation in the insula cortex (Sanfey et al. 2003).

## Fairness as partiality
...
This envy-avoidance theory of distrust also considers the role of fairness in shaping individuals' experiences of envy, which can vary in their underlying attributions and motivations.
